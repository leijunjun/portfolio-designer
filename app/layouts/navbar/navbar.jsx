  ...
  return (
    <header className={styles.navbar} ref={headerRef}>
      <RouterLink
        ...
        aria-label={`${t('intro.name')}, ${t('intro.role')}`}
      ...
      <nav className={styles.nav}>
        <div className={styles.navList} data-language={language}>
          {navLinks.map(({ labelKey, pathname }) => (
            <RouterLink
              unstable_viewTransition
              prefetch="intent"
              to={pathname}
      ...
      <Transition unmount in={menuOpen} timeout={msToNum(tokens.base.durationL)}>
        {({ visible, nodeRef }) => (
          <nav className={styles.mobileNav} data-visible={visible} ref={nodeRef}>
            {navLinks.map(({ labelKey, pathname }, index) => (
              <RouterLink
                unstable_viewTransition
                prefetch="intent"
                to={pathname}
      ...
      {!isMobile && (
        <div className={styles.utilityToggles} data-navbar-item>
          <LanguageToggle />
          <ThemeToggle />
        </div>
      )}
